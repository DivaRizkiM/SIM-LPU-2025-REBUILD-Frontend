...
import {  syncProduksiNasional } from "../../../../../services"
import { toast } from "@/components/ui/use-toast"
import { context } from "../../../../../store"

export function DataProduksiNasional() {
    ...
    const onSync = async()=> {
        ...
        try {
            ...
            const res = await syncProduksiNasional(router,params);
    ...
    const onClickSync = ()=> {
        ctx.dispatch({
            alertDialog: {
                title: `Apakah anda yakin ingin menyinkronkan data produksi nasional?`,
                type: 'sync',
                onSubmit: async()=>{
                    await onSync()
                }
    ...
    <Card className="overflow-hidden">
        <CardHeader className="bg-sky-300 dark:bg-sky-950 mb-5">
            <CardTitle>Data Produksi Nasional</CardTitle>
        </CardHeader>
