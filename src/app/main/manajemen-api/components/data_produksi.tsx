...
import { getJenisBisnis, getKPRK, getKpcByKcu, getRegional, syncProduksi } from "../../../../../services"
...
export function DataProduksi() {
    ...
    const onSync = async()=> {
        ...
        try {
            ...
            const res = await syncProduksi(router,params);
    ...
    const onClickSync = ()=> {
        ctx.dispatch({
            alertDialog: {
                title: `Apakah anda yakin ingin menyinkronkan data produksi?`,
                type: 'sync',
                onSubmit: async()=>{
                    await onSync()
                }
