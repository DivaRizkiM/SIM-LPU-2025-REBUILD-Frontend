...
import { syncDashboardProduksiPendapatan } from "../../../../../services"
import months from '@/lib/months.json'
import { context } from "../../../../../store"
import { cn } from "@/lib/utils"

export function DataDashboardProduksiPendapatan() {
    ...
    const onSync = async()=> {
        ...
        try {
            ...
            const res = await syncDashboardProduksiPendapatan(router,params);
    ...
    const onClickSync = ()=> {
        ctx.dispatch({
            alertDialog: {
                title: `Apakah anda yakin ingin menyinkronkan data Dashboard Produksi & Pendapatan?`,
                type: 'sync',
                onSubmit: async()=>{
                    await onSync()
                }
    ...
    <Card className="overflow-hidden">
        <CardHeader className="bg-sky-300 dark:bg-sky-950 mb-5">
            <CardTitle>Dashboard Produksi & Pendapatan</CardTitle>
        </CardHeader>
