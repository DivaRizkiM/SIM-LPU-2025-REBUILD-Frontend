...
export const columns: ColumnDef<VerifikasiProduksiI>[] = [
  {
    accessorKey: "number",
    header: "No",
  ...
  },
  {
    ...
    accessorFn: (originalRow) => originalRow.tahun_anggaran.toString(), // matches is a number
    header: ({ column }) => {
      return (
        <Button
          variant="ghost"
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return (
       <Link 
        href={`./verifikasi-produksi/verifikasi-kprk?regID=${data.id_regional}&tahun=${data.tahun_anggaran}&triwulan=${data.triwulan}`} 
        className={cn(
