...
export const columns: ColumnDef<VerifikasiKprkI>[] = [
  ...
  },
  {
    ...
    cell: ({ row,table }) => {
      ...
      return (
       <Link 
        href={`./pelaporan-verifikasi?id_produksi=${data.produksi_id}&kcu_id=${data.id_kcu}&triwulan=${data.triwulan}&tahun=${data.tahun_anggaran}&id_kpc=${data.id_kpc}&id_regional=${meta.id_regional}`} 
        className={cn(
