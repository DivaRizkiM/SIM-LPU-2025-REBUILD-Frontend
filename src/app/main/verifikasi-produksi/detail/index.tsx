...
import {
  getDetailVerifikasiProduksi,
  postVerifikasiProduksi,
} from "../../../../../services";
...
const Detail: FC<IDetailVerifProduksi> = ({ id_produksi_detail, trigger, isLock = false }) => {
  ...
  const firstInit = async () => {
    ...
    await getDetailVerifikasiProduksi(router, params)
      .then((res) => {
        ...
        const tempDataVerifs: IFormVerifikasiProduksi[] = dataResponse.map(
          (data) => {
            return {
  ...
  const onSubmitVerifikasi = async () => {
    ...
    const tempData: Array<any> = dataVerifications.map((data) => {
      ...
      console.log("Verifikasi Produksi:", {
    ...
    <div className="relative px-2 md:px-4" id="trest">
      ...
      <div
        className={cn(
          ...
          "rounded-md md:px-3 p-2 w-full transition-all duration-200"
        )}
        ref={containerRef}
      >
        <div className="space-y-2">
          <div className="grid gap-2 md:grid-cols-4 items-center">
            ...
            <Input
              value={selectedData?.jenis_layanan}
          ...
          <div className="grid gap-2 md:grid-cols-4 items-center">
            ...
            <Input
              value={selectedData?.produk_keterangan}
              className="w-full col-span-3 bg-secondary"
              readOnly
            />
          </div>
