...
import { FilePenIcon, Lock, LockKeyholeOpen, MoreHorizontal } from "lucide-react"
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                  ...
                  <DropdownMenuSeparator />
                    <DropdownMenuItem 
                      onClick={()=>meta.onClickEditData(data.laporan[monthIndex-1].id_produksi_detail)}
                      className={isLock ? 'pointer-events-none opacity-50': ''}
                    >
