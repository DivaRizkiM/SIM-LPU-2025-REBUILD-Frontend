...
import { getKategoriBiaya } from "../../../../../services";
...
export default function JenisBisnis() {
    ...
    const firstInit = ()=> {
      try {
        getKategoriBiaya(router,'?limit=9999')
        .then((res)=>{
    ...
    <div className="px-2 md:px-4 py-1 md:py-2">
        <h3 className="scroll-m-20 text-xl font-semibold tracking-tight mb-3 border-b pb-2">Kategori Biaya</h3>
