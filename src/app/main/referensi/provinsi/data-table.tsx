...
import { deleteProvinsi, syncProvinsi } from "../../../../../services"
...
export function DataTable<TData, TValue>({
  ...
  fetchData
    ...
    const showAlertDelete = (data:ProvinsiI) => {      
      ctx.dispatch({
        alertDialog: {
          type: 'delete',
    ...
    const onDeleteData = async (data:ProvinsiI) => {      
      await deleteProvinsi(router,data.id)
        .then(()=>{
          toast({
    ...
    const onClickEditData = (data:ProvinsiI)=>{
      ctx.dispatch({
        isModal: {
    ...
    const onSyncClick = ()=> {
      ctx.dispatch({
        alertDialog: {
          type: 'sync',
          title: `Apakah anda yakin ingin menyinkronkan Provinsi?`,
          onSubmit: async()=>{
            await syncProvinsi(router)
              .then((res)=>{
                toast({
