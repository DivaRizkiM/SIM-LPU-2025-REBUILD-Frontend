            ...
            <div className="flex space-x-2 h-full">
                ...
                <div className={cn(animateTrigger ? 'translate-x-5 md:translate-x-10 opacity-50' : 'translate-x-0 opacity-1', 'rounded-md border md:px-3 p-2 w-full h-full overflow-y-scroll overflow-x-hidden transition-all duration-200')} ref={containerRef}>
                    ...
                    <div className="grid md:grid-cols-2 gap-4 mb-10">
                        ...
                        {
                            selectedData?.kode_rekening != 5000000010 ?
                                <>
                                    ...
                                    <div className="grid gap-2 md:grid-cols-4 items-center">
                                        ...
                                        <div className="w-full md:col-span-3 opacity-80 border-dotted decoration-muted-foreground border-l ps-2 md:ps-3 flex">{selectedData?.npp || "0"}</div>
                                    </div>
                                    <div className="grid gap-2 md:grid-cols-4 items-center">
                                        <Label>Nilai Setelah Proporsi</Label>
                                        <div className="w-full md:col-span-3 opacity-80 border-dotted decoration-muted-foreground border-l ps-2 md:ps-3 flex">{selectedData?.proporsi || "0"}</div>
                                    </div>
                                    <div className="grid gap-2 md:grid-cols-4 items-center">
                                        <Label>Biaya NPP Per KCP</Label>
                                        <div className="w-full md:col-span-3 opacity-80 border-dotted decoration-muted-foreground border-l ps-2 md:ps-3 flex">{selectedData?.biaya_per_npp || "0"}</div>
                                    </div>
                                </>
                                :
                                <>
                                    <div className="grid gap-2 md:grid-cols-4 items-center">
                                        <Label>Keterangan</Label>
                                        <div className="w-full md:col-span-3 opacity-80 border-dotted decoration-muted-foreground border-l ps-2 md:ps-3 flex">{selectedData?.keterangan || "0"}</div>
                                    </div>
                                    <div></div>
                                    ...
                                    <div className="grid gap-2 md:grid-cols-4 items-center">
                                        ...
                                        <div className="w-full md:col-span-3 opacity-80 border-dotted decoration-muted-foreground border-l ps-2 md:ps-3 flex">{selectedData?.hasil_perhitungan_fase_1 || "0"}</div>
                                    </div>
                                    <div></div>

                                    <div className="grid gap-2 md:grid-cols-4 items-center">
                                        <Label>Perhitungan Fase 2</Label>
                                        <div className="w-full md:col-span-3 opacity-80 border-dotted decoration-muted-foreground border-l ps-2 md:ps-3 flex">{selectedData?.rumus_fase_2 || "0"}</div>
                                    </div>
                                    <div></div>

                                    <div className="grid gap-2 md:grid-cols-4 items-center">
                                        <Label>Hasil Perhitungan Fase 2</Label>
                                        <div className="w-full md:col-span-3 opacity-80 border-dotted decoration-muted-foreground border-l ps-2 md:ps-3 flex">{selectedData?.hasil_perhitungan_fase_2 || "0"}</div>
                                    </div>
                                    <div></div>

                                    <div className="grid gap-2 md:grid-cols-4 items-center">
                                        <Label>Perhitungan Fase 3</Label>
                                        <div className="w-full md:col-span-3 opacity-80 border-dotted decoration-muted-foreground border-l ps-2 md:ps-3 flex">{selectedData?.rumus_fase_3 || "0"}</div>
                                    </div>
                                    <div></div>

                                    <div className="grid gap-2 md:grid-cols-4 items-center">
                                        <Label>Hasil Perhitungan Fase 3</Label>
                                        <div className="w-full md:col-span-3 opacity-80 border-dotted decoration-muted-foreground border-l ps-2 md:ps-3 flex">{selectedData?.hasil_perhitungan_fase_3 || "0"}</div>
                                    </div>
                                </>
                        }
                    </div>
