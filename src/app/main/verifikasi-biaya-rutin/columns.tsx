...
export interface VerifikasiRutinI {
  id: string
  number: number
  triwulan: number
  tahun: string
...
export const columns: ColumnDef<VerifikasiRutinI>[] = [
  {
    accessorKey: "number",
    header: "No",
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return (
       <Link 
        href={`verifikasi-biaya-rutin/verifikasi-kprk?regID=${data.id_regional}&tahun=${data.tahun}&triwulan=${data.triwulan}`} 
        className={cn(
