...
export const columns: ColumnDef<BiayaNppNasionalI>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      return <div className="text-left">{row.original.kode_rekening}</div>;
    },
  },
  {
    ...
    cell: ({ row }) => {
      return <div className="text-left">{row.original.nama_rekening}</div>;
    },
  },
  {
    accessorKey: "bulan",
    ...
    cell: ({ row }) => {
      return <div className="text-center">{row.original.bulan}</div>;
    },
  },
  {
    accessorKey: "tahun",
    ...
    cell: ({ row }) => {
      return (
        <div className="text-center">
          Rp. {numFormatter(row.original.nominal)}
        </div>
      );
    },
  },
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return <Badge variant={getStatusColor()}>{data.status}</Badge>;
    },
  },
];
