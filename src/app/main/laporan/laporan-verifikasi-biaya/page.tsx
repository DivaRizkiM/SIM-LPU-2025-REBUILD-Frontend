...
import {
  getExportPrognosaPendapatan,
  getExportVerifikasiBiaya,
  getExportVerifikasiPendapatan,
  getKPRK,
  getKPRKByRegional,
  getKertasKerjaVerifikasi,
  getRegional,
  getVerifikasiBiaya,
  getVerifikasiPendapatan,
} from "../../../../../services";
...
const LaporanVerifikasiBiaya: NextPage = () => {
  ...
  const filterByTahun = (value: string) => {
    ...
    setPage(1);
    fetchData(1, value, triwulanSelected, regionalSelected, kcuSelected);
  };
  const filterByTriwulan = (value: string) => {
    setPage(1);
    setTriwulanSelected(value);
    fetchData(1, tahunSelected, value, regionalSelected, kcuSelected);
  };
  ...
  return (
    <div className="px-3 lg:px-7 mt-5">
      ...
      <h1 className="text-center my-7 md:my-3 font-bold">
