...
import { getExportPrognosaBiaya, getKPRKByRegional, getPrognosaBiaya, getRegional } from "../../../../../services";
import { useRouter } from "next/navigation";
import { RegionalI } from "../../referensi/regional/columns";
import { LaporanBiayaI } from "../../../../../services/types";
import { QueryParams, buildQueryParam, numFormatter } from "../../../../../helper";
...
const LaporanVerifikasiBiaya:NextPage = ()=>{
    ...
    const fetchData = async(pagination=1, tahun='',triwulan='',regional='',kcu='') => {
        ...
        if (offset < 0)return
        await getPrognosaBiaya(router, params)
        .then((res)=> {
            const { 
                offset,
                limit,
    ...
    const exportData = async()=>{
        ...
        const params = buildQueryParam(tempParams) || '';
        await getExportPrognosaBiaya(router,params)
            .then((res)=>{
    ...
    return(
        <div className="px-3 lg:px-7 mt-5">
            ...
            <h1 className="text-center my-7 md:my-3 font-bold">LAPORAN PROGNOSA BIAYA</h1>
