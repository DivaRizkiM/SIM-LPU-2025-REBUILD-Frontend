...
import { getExportKertasKerjaVerifikasi, getKertasKerjaVerifikasi, getRegional } from "../../../../../services";
...
const KertasKerjaVerifikasi:NextPage = ()=>{
    ...
    const fetchData = async(pagination=1, tahun='',triwulan='',regional='') => {
        setIsLoading(true)
    ...
    return(
        <div className="px-3 md:px-7 mt-5">
            ...
            <h1 className="text-center my-7 md:my-3">KERTAS KERJA VERIFIKASI DOKUMEN <br/>PENYELENGGARAAN LAYANAN POS UNIVERSAL PT. POS INDONESIA</h1>
