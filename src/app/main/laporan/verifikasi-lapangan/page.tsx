...
import { getExportVerifikasiLapangan, getKabKota, getKecamatan, getKelurahan, getProvinsi, getVerifikasiLapangan } from "../../../../../services";
import { useRouter } from "next/navigation";
import { KabKotaI, KecamatanI, KelurahanI, ProvinsiI, VerifikasiLapanganI } from "../../../../../services/types";
...
const MonitoringKantorUsulan:NextPage = ()=>{
    ...
    const [dataSource, setDataSource] = useState<VerifikasiLapanganI[]>()
    ...
    const fetchData = async(pagination=1, id_provinsi='',id_kabupaten_kota='',id_kecamatan='',id_kelurahan='',tahun='',bulan='') => {
        ...
        if (offset < 0)return
        await getVerifikasiLapangan(router, params)
        .then((res)=> {
            const { 
                offset,
                limit,
    ...
    const exportData = async(dataForm: z.infer<typeof FormSchema>)=>{
        ...
        const params = buildQueryParam(tempParams) || '';
        await getExportVerifikasiLapangan(router,params)
            .then((res)=>{
                const url = window.URL.createObjectURL((res.data as any));
                const a = document.createElement('a');
                a.style.display = 'none';
                a.href = url;
                const fileNameParts = [`verifikasi_lapangan`];
    ...
    return(
        <div className="px-3 lg:px-7 mt-5">
            ...
            <h1 className="text-center my-7 md:my-3 font-bold">Verifikasi Lapangan</h1>
                ...
                <table className={style.table}>
                    <thead className="[&:nth-child(3):bg-red-900]">
                        ...
                        <tr>
                            ...
                            <th>ASPEK PEMAHAMAN PEGAWAI (25%)</th>
                            <th>ASPEK PEMAHAMAN WILAYAH (25%)</th>
                            <th>ASPEK SARANA & PRASARANA (25%)</th>
                        </tr>
                    </thead>
                    <tbody>
