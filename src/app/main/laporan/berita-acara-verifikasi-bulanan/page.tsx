...
import { postExportBeritaAcaraVerifikasiBulanan } from "../../../../../services";
...
const BeritaAcaraPenarikan:NextPage = ()=>{
    ...
    const onSubmit = async (dataForm: z.infer<typeof FormSchema>)=>{
        ...
        try {
            const response = await postExportBeritaAcaraVerifikasiBulanan(router,dataForm)
      ...
      link.href = url;
      link.setAttribute("download", "berita-acara-verifikasi-bulanan.pdf");
    ...
    const convertHtmlToPdf = (html: any) => {
        ...
        doc.html(mainElement, {
            callback: function (doc) {
                doc.save('Berita Acara Verifikasi Bulanan.pdf');
            },
            html2canvas: {
                scale: .75
            },
    ...
    return(
        <div className="px-3 lg:px-7 mt-5">
            ...
            <h1 className="text-center my-7 md:my-3 font-bold text-2xl">Berita Acara Verifikasi Bulanan</h1>
            <Form {...form}>
