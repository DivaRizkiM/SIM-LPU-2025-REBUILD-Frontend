...
const FormSchema = z.object({
    ...
    no_berita_acara: z.string({required_error: 'No. berita acara tidak boleh kosong'}),
...
const BeritaAcaraPenarikan:NextPage = ()=>{
    ...
    return(
        <div className="px-3 lg:px-7 mt-5">
            ...
            <h1 className="text-center my-7 md:my-3 font-bold text-2xl">Berita Acara Penarikan</h1>
            <Form {...form}>
