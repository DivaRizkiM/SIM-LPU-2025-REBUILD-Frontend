...
import { Edit, QrCode, Trash, Users2 } from "lucide-react";
    ...
    cell: ({ row }) => {
      ...
      return (
        <ul className="list-disc ms-1">
          <li>
            senin-kamis:{" "}
            {data.jam_kerja_senin_kamis && data.jam_kerja_senin_kamis + " WIB"}
          </li>
          <li>
            Jum&apos;at: {data.jam_kerja_jumat && data.jam_kerja_jumat + " WIB"}
          </li>
          <li>
            Sabtu: {data.jam_kerja_sabtu && data.jam_kerja_sabtu + " WIB"}
          </li>
        </ul>
      );
    },
    ...
    cell: ({ row, table }) => {
      ...
      return (
        <div className="flex flex-wrap gap-1">
          ...
          <Button
            onClick={() => meta.onClickPrintQR(data)}
            size="icon"
            variant="outline"
            title="Cetak QR Code"
          >
