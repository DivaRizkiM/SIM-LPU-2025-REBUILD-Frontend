...
export interface IFormPegawaiVerifikasi {
  id_pegawai_detail: string | number
  verifikasi: string
  catatan_pemeriksa?: string
  isVerifikasiSesuai?: "0" | "1" | ""
}
export interface IFormGajiPegawai {
  id_pegawai_detail: string | number
  verifikasi: string
  catatan_pemeriksa?: string
  isVerifikasiSesuai?: "0" | "1" | ""
}
export interface IFormProduksiPendapatanVerifikasi {
  id_dpp: string | number
  verifikasi_jumlah_produksi: string
  verifikasi_jumlah_pendapatan: string
  verifikasi_koefisien: string
  catatan_pemeriksa?: string
  isProduksiSesuai?: "0" | "1" | "";
  isKoefisienSesuai?: "0" | "1" | ""
}
...
export interface NppI {
  ...
  produksi_nasional: string;
  pendapatan_kcp_nasional: string;
  produksi_kcp_nasional: string;
  proporsi: string;
  url_file: string;
  last_two_digits: string;
}
export interface BiayaGajiPegawaiI {
  id: string
  nama_pegawai: string
  jabatan: string
  nama_bagian: string
...
export interface LtkI {
  ...
  verifikasi_pso_ori: string;
  total_produksi_ltk?: string;
  total_produksi_kurir_ltk?: string;
  hasil_perhitungan_fase_1?: string;
  hasil_common_cost?: string;
  total_produksi_ltk_kantor_lpu?: string;
...
export interface IFormLtkVerifikasi {
  id_ltk: string | number;
  verifikasi_akuntansi: string;
  isVerifikasiAkuntansiSesuai?: "0" | "1" | "";
  verifikasi_pso: string;
